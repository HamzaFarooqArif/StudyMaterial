        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                if self.ant and self.ant.can_contain(insect):
                    ...
                    self.ant = insect # What to do when Bodyguard dies?
                else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while count < self.min_range:
            ...
            count += 1
        count = 0
        while len(current.bees) == 0 and current.entrance.name != 'Hive' and current.entrance and count < self.max_range:
            current = current.entrance
            count += 1
        ...
        if not self.real:
            ...
            while current:
                if current.ant:
                    ...
                    if current.ant.container and current.ant.ant and current.ant.ant not in self.inspired:
