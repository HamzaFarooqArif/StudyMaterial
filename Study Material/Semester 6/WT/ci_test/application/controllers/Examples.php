...
class Examples extends CI_Controller {
    ...
    { 
            ...
            $crud->add_action('orderdetails',base_url().'','Examples/order_detail_management'); //new button orderdetail add
            $output = $crud->render();
            $this->_example_output($output);
...
public function order_detail_management()
    {
            ...
            $crud->where('orderNumber',$orderNo);
...
public function offices_management_with_actions()
{
$crud = new grocery_CRUD();
...
return site_url('demo/action/action_photos').'?country='.$row->country;
	...
	public function offices_management()
	{
		try{
			...
			$crud->set_table('offices');
			$crud->set_subject('Office');
			$crud->required_fields('city','country');
